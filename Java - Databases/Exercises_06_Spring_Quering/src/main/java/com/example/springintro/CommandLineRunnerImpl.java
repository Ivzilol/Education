...
//                "so total of %d book copies were added", booksUpdated, date, amount * booksUpdated);
...
//        05
//        String date = scanner.nextLine();
//        this.bookService.findBookReleaseBeforeDate(date)
...
//        this.bookService.findNotReleasedInIn(releaseYear)
