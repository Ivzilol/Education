...
import com.example.exercises_07_json_procesing.productshop.entities.categories.CategoryImportDTO;
import com.example.exercises_07_json_procesing.productshop.entities.products.ProductImportDTO;
import com.example.exercises_07_json_procesing.productshop.entities.users.User;
import com.example.exercises_07_json_procesing.productshop.entities.users.UserImportDTO;
import com.example.exercises_07_json_procesing.productshop.repositories.CategoryRepository;
...
public class SeedServiceImpl implements SeedService {
    ...
    public void seedCategories() throws FileNotFoundException {
        FileReader fileReader = new FileReader(CATEGORIES_JSON_PATH.toAbsolutePath().toFile());
    ...
    public void seedProducts() throws FileNotFoundException {
        FileReader fileReader = new FileReader(PRODUCTS_JSON_PATH.toAbsolutePath().toFile());
